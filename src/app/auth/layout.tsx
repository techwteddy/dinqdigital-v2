      ...
      <div className="relative hidden w-full flex-col justify-between overflow-hidden bg-gradient-to-br from-primary via-primary to-violet-600 p-10 text-primary-foreground lg:flex lg:w-[45%] xl:w-[42%]">
        ...
        <div className="relative">
          <Link href="/" className="flex items-center gap-2.5 text-primary-foreground">
            ...
            <span className="text-lg font-semibold tracking-tight">Launch faster</span>
          </Link>
        </div>
        <blockquote className="relative max-w-md">
          <p className="text-2xl font-semibold leading-snug tracking-tight">
            &ldquo;The best SaaS boilerplate is the one that gets out of your way — so you can
            ship what customers actually pay for.&rdquo;
          </p>
          <footer className="mt-6 text-sm text-primary-foreground/80">
            Built for founders, agencies, and product teams
          </footer>
        </blockquote>
        <p className="relative text-sm text-primary-foreground/70">{APP_DESCRIPTION}</p>
      </div>
