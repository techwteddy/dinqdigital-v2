...
-- CreateIndex
CREATE UNIQUE INDEX "plans_stripePriceIdMonth_key" ON "plans"("stripePriceIdMonth");

-- CreateIndex
CREATE UNIQUE INDEX "plans_stripePriceIdYear_key" ON "plans"("stripePriceIdYear");
